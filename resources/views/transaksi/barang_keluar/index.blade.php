...
<div class="animate-fadeIn space-y-6">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <form action="{{ route('barang-keluar.index') }}" method="GET"
            ...
            <input type="text" name="search" value="{{ request('search') }}"
                   placeholder="Cari barang / customer / tanggal..."
    ...
    <div>
        <a href="{{ route('barang-keluar.create') }}"
           class="inline-flex items-center gap-2 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all shadow-sm">
                    ...
                    @forelse($data as $index => $row)
                        <tr class="border-b hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 py-2 text-center flex justify-center gap-2">
                                {{-- Edit --}}
                                <a href="{{ route('barang-keluar.edit', $row->id) }}"
